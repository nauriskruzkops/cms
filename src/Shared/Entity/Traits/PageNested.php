...
trait PageNested {
     ...
     * @var Page
     * @Gedmo\TreeRoot
     * @ORM\ManyToOne(targetEntity="Shared\Entity\Page")
     ...
     * @var Page
     * @Gedmo\TreeParent
     * @ORM\ManyToOne(targetEntity="Shared\Entity\Page", inversedBy="children")
     * @ORM\JoinColumn(referencedColumnName="id", onDelete="CASCADE")
     */
    private $parent;
     ...
     * @ORM\OneToMany(targetEntity="Shared\Entity\Page", mappedBy="parent")
